...
////    
////    val allLeaves = ruleMap.values.flatMap { it.allLeaves.asIterable() }.toSet()
////    
////    
////    //-----------Setup tags
////    
...
////    //-------------Setup Contexts
////
//////        ruleMap["atom"]!!.allLeaves.find { it.text == "NAME" }?.also { 
...
//    
//    
//    // spread tags concretely to the allLeaves of the rules
//    
//    ruleMap["augassign"]!!.setGroupingTag(tags["augassign"]!!)
//    
...
//    
//    
//    // assign same tags to multiple allLeaves. (rules with the same text can meet many times)
//    allLeaves.forEach {
//        when (it.text) {
//            "or", "and", "not" -> it.groupingTag = tags["bool_op"]!!
...
//    ruleMap["trailer"]!!.allLeaves
//            .plus(ruleMap["arglist"]!!.allLeaves)
//            .plus(ruleMap["classdef"]!!.allLeaves)
